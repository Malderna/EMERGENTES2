...
<%
    ...
    if (session.getAttribute("lista_tarea") == null) {
        ...
        Tarea t1 = new Tarea(1,"Reunion de estudiantes dela UPEA",true);
        Tarea t2 = new Tarea(2,"Resolución de problemas matemáticos y científicos",true);
        Tarea t3 = new Tarea(3,"Defensa de proyecto de grado",false);
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2>Nombre : Kevin Malderna Aduviri</h2>
